...
from app.core.exceptions import AppException, NotFoundException, InternalServerError
...
@router.post(
    "/{resource_id}/containers/{container_id}/start", response_model=MessageResponse
)
...
@router.post(
    "/{resource_id}/containers/{container_id}/stop", response_model=MessageResponse
)
...
@router.post(
    "/{resource_id}/containers/{container_id}/restart", response_model=MessageResponse
)
...
@router.get(
    "/{resource_id}/containers/{container_id}/logs",
...
@router.delete(
    "/{resource_id}/containers/{container_id}", response_model=MessageResponse
)
